...
class TestCEPFlow(unittest.TestCase):
    ...
    def test_simple_operators(self):
        self.assertTrue(cep_executer(expression="6 + 4 == 10", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="0 - 53 == -53", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="3 * 18 == 54", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="45 / 9 == 5", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="7.5 + 3.22 == 10.72", variables={}, payload={}))

        self.assertFalse(cep_executer(expression="6 + 4 == 18", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="0 - 53 == 53", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="3 * 18 == 23", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="45 / 9 == 3", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="7.5 - 3.22 == 10.72", variables={}, payload={}))

    def test_comparison_operators(self):
        self.assertTrue(cep_executer(expression="7 == 7", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="7 != 9", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="0 < 10", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="10 > -8", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="9 <= 10", variables={}, payload={}))
        self.assertTrue(cep_executer(expression="12 >= 11", variables={}, payload={}))

        self.assertFalse(cep_executer(expression="7 != 7", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="7 == 9", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="0 > 10", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="10 < -8", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="13 <= 10", variables={}, payload={}))
        self.assertFalse(cep_executer(expression="12 >= 14", variables={}, payload={}))
    ...
    def test_expression_with_variables(self):
        ...
        self.assertTrue(cep_executer(expression="x + y == 28", variables={"x": 0, "y": 28}, payload={}))
        self.assertTrue(cep_executer(expression="y - x == -28", variables={"x": 28, "y": 0}, payload={}))
        self.assertTrue(cep_executer(expression="0 > x and y + 3 > 4 or 50 - x == 40", variables={"x": 10, "y": 5}, payload={}))
        self.assertFalse(cep_executer(expression="y - x != -24", variables={"x": 24, "y": 0}, payload={}))
        self.assertFalse(cep_executer(expression="0 > y and 5 + 3 > 4 and x - 10 == 40", variables={"x": 3, "y": 5}, payload={}))
