...
class FlowValidationText(unittest.TestCase):
    ...
    def test_valid_flow_validation(self):
        ...
        flow_ops = [FlowOperationEntity("op_name", "sensor_temperature", None, "actuator_led", "*"),
                    FlowOperationEntity("op_name2", None, "log", None, "node1, node2"),
                    FlowOperationEntity("op_name3", None, "cep_intercept", "actuator_speaker", "node1")]
    ...
    def test_invalid_flow_validation(self):
        ...
        flow_ops = [FlowOperationEntity(test_name, test_op_name, None, test_output_op, "*"),
        ...
        flow_ops2 = [FlowOperationEntity(test_name, test_op_name2, None, test_output_op, "*"),
                     FlowOperationEntity(test_name2, None, test_process_op, None, "*"),
                     FlowOperationEntity(test_name3, None, "cep_intercept_test", test_output_op2, "*")]
        ...
        flow_ops3 = [FlowOperationEntity(test_name, "test_op_name", None, test_output_op, "*"),
                     FlowOperationEntity(test_name2, None, test_process_op, None, "*"),
        ...
        flow_ops5 = [FlowOperationEntity(test_name, test_op_name, None, test_output_op, "*")]
        ...
        flow_ops6 = [FlowOperationEntity(test_name, test_op_name, None, test_output_op, "*"),
                     FlowOperationEntity(test_name2, None, test_process_op, None, "*"),
                     FlowOperationEntity(test_name3, test_op_name, test_process_op2, test_output_op2, "*")]
        ...
        flow_ops7 = [FlowOperationEntity(test_name, test_op_name3, None, test_output_op, "*"),
                     FlowOperationEntity(test_name2, None, test_process_op, None, "*"),
                     FlowOperationEntity(test_name3, None, "cep_intercept_test", test_output_op2)]
        ...
        flow_ops9 = [FlowOperationEntity(test_name, None, None, test_output_op, "*"),
                     FlowOperationEntity(test_name2, None, test_process_op, None, "*"),
                     FlowOperationEntity(test_name3, None, test_process_op2, test_output_op2)]
        flow9 = FlowEntity("test_flow", flow_ops9)
        self.assertEqual((False, "No input defined!"), flow_validation_service.is_flow_valid(flow9))
        flow_ops10 = [FlowOperationEntity(test_name, test_op_name, None, test_output_op, "*"),
                      FlowOperationEntity(test_name2, None, test_process_op, None, "*"),
                      FlowOperationEntity(test_name3, None, test_process_op2, test_output_op2, "test")]
        ...
        flow_ops11 = [FlowOperationEntity(test_name, test_op_name, None, test_output_op, "*"),
        ...
        flow_ops12 = [FlowOperationEntity(test_name, test_op_name, None, test_output_op, "*"),
